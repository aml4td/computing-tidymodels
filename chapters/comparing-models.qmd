...
req_pkg <- c("bestNormalize", "broom.mixed", "C50", "discrim", "embed", 
             "glmnet", "klaR", "lme4", "multcomp", "rstanarm", "rules", 
             "spatialsample", "splines2", "tidymodels", "tidyposterior")
```
...
# For spatial resampling methods:
...
load(url(
  "https://github.com/aml4td/website/raw/refs/heads/main/RData/forested_data.RData"
))

# Load information needed for interactions:
load(url(
  "https://github.com/aml4td/website/raw/refs/heads/main/RData/forested_interactions.RData"
))
```
...
#| label: levels
#| echo: false
lvls <- cli::format_inline(
  "{.code {levels(factor(accuracy_long_df$pipeline))}}"
)
```
