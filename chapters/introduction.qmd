...
- [`workshops.tidymodels.org`](https:/workshops.tidymodels.org/): our currently training materials.
...
We will do our best to use versions of our packages corresponding to the CRAN versions. We can't always do that, and, for many packages, a version number ending with a value in the 9000 range (e.g., version "1.1.4.9001") means that it was a development version of the package. 
